...
molochPlugin.prototype.start = function(callback) {
  ...
  if (this.options.print_stats){
    ...
    this.timer = setInterval(function () {
      ...
      console.log('' + now + 'in post:'+this.inPost + ' in queue:' + _this.eventQueue.length + ' in total: '+_this.eventCountIN+' last minute:'+lastMinuteCountIN+' rate:'+lastMinuteRateIN+'eps'+' droped:'+dropedEventCount+paused);
