...
molochPlugin.prototype.start = function(callback) {
  ...
  if (this.options.print_stats){
    ...
    this.timer = setInterval(function () {
      ...
      console.log('' + now + ' in queue:' + _this.queue.length + ' in total: '+_this.eventCountIN+' last minute:'+lastMinuteCount+' rate:'+lastMinuteRate+'eps'+' droped:'+dropedEventCount+paused);
